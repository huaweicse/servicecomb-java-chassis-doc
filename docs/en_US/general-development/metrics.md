...
```
{
"threadpool.taskCount(id=cse.executor.groupThreadPool-group0)":7393.0,
"threadpool.taskCount(id=cse.executor.groupThreadPool-group1)":8997.0,
"threadpool.currentThreadsBusy(id=cse.executor.groupThreadPool-group0)":1.0,
"threadpool.currentThreadsBusy(id=cse.executor.groupThreadPool-group1)":0.0,
"threadpool.poolSize(id=cse.executor.groupThreadPool-group0)":8.0,
"threadpool.poolSize(id=cse.executor.groupThreadPool-group1)":8.0,
"threadpool.completedTaskCount(id=cse.executor.groupThreadPool-group0)":7393.0,
"threadpool.completedTaskCount(id=cse.executor.groupThreadPool-group1)":8997.0,
"threadpool.maxThreads(id=cse.executor.groupThreadPool-group0)":8.0,
"threadpool.maxThreads(id=cse.executor.groupThreadPool-group1)":8.0,
"threadpool.queueSize(id=cse.executor.groupThreadPool-group0)":0.0,
"threadpool.queueSize(id=cse.executor.groupThreadPool-group1)":0.0,
"threadpool.corePoolSize(id=cse.executor.groupThreadPool-group0)":8.0,
"threadpool.corePoolSize(id=cse.executor.groupThreadPool-group1)":8.0,
